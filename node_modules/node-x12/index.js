...
Object.defineProperty(exports, "__esModule", { value: true });
const JSEDINotation_1 = __webpack_require__(1);
const Positioning_1 = __webpack_require__(8);
const X12Element_1 = __webpack_require__(7);
const X12Enumerables_1 = __webpack_require__(3);
...
class X12Segment {
    ...
    _formatValues(values) {
        if (this._checkSupportedSegment()) {
            ...
            if (this.tag === X12Enumerables_1.X12SupportedSegments.ISA && this.options.subElementDelimiter.length === 1) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const JSEDINotation_1 = __webpack_require__(1);
const X12Segment_1 = __webpack_require__(2);
const X12Enumerables_1 = __webpack_require__(3);
...
class X12Transaction {
     ...
     */
    toObject(map, helper) {
        const mapper = new X12TransactionMap_1.X12TransactionMap(map, this, helper);
...
const string_decoder_1 = __webpack_require__(15);
const Errors_1 = __webpack_require__(4);
const Positioning_1 = __webpack_require__(8);
const X12Diagnostic_1 = __webpack_require__(16);
const X12FatInterchange_1 = __webpack_require__(17);
...
class X12Parser extends stream_1.Transform {
    ...
    getInterchangeFromSegments(segments, options) {
        this._options = options === undefined ? this._options : X12SerializationOptions_1.defaultSerializationOptions(options);
        segments.forEach((segment) => {
            this._processSegment(segment);
        });
        return this._fatInterchange === undefined
    ...
    _detectOptions(edi, options) {
        ...
        if (options === undefined) {
            ...
            this._options = X12SerializationOptions_1.defaultSerializationOptions(options);
        }
    }
...
class X12FatInterchange extends Array {
    ...
    constructor(items, options) {
        if (Array.isArray(items)) {
            ...
            super();
            this.options = X12SerializationOptions_1.defaultSerializationOptions(items);
        }
        if (options !== undefined) {
            this.options = X12SerializationOptions_1.defaultSerializationOptions(options);
        }
